...
import com.mycompany.myapp.domain.enumeration.DurationMeasure;
import com.mycompany.myapp.domain.enumeration.TourKind;
import com.mycompany.myapp.domain.enumeration.TourMode;
...
class TourResourceIT {
    ...
    public void cleanup() {
        if (insertedTour != null) {
            tourRepository.delete(insertedTour);
            insertedTour = null;
        }
    }
    ...
    void getAllTours() throws Exception {
        ...
        insertedTour = tourRepository.saveAndFlush(tour);
