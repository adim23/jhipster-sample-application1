...
import com.mycompany.myapp.repository.TourExtraRepository;
import com.mycompany.myapp.repository.UserRepository;
import com.mycompany.myapp.service.TourExtraService;
import com.mycompany.myapp.service.dto.TourExtraDTO;
import com.mycompany.myapp.service.mapper.TourExtraMapper;
...
class TourExtraResourceIT {
    ...
    private TourExtra insertedTourExtra;
    ...
    @AfterEach
    public void cleanup() {
        if (insertedTourExtra != null) {
            tourExtraRepository.delete(insertedTourExtra);
            insertedTourExtra = null;
        }
    }
    ...
    void createTourExtra() throws Exception {
        ...
        insertedTourExtra = returnedTourExtra;
    }
    ...
    void getAllTourExtras() throws Exception {
        ...
        insertedTourExtra = tourExtraRepository.saveAndFlush(tourExtra);
