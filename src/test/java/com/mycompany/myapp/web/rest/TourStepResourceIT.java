...
class TourStepResourceIT {
    ...
    private TourStep insertedTourStep;
    ...
    @AfterEach
    public void cleanup() {
        if (insertedTourStep != null) {
            tourStepRepository.delete(insertedTourStep);
            insertedTourStep = null;
        }
    }
    ...
    void createTourStep() throws Exception {
        ...
        insertedTourStep = returnedTourStep;
    }
    ...
    void getAllTourSteps() throws Exception {
        ...
        insertedTourStep = tourStepRepository.saveAndFlush(tourStep);
