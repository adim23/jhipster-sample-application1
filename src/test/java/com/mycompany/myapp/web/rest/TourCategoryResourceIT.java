...
class TourCategoryResourceIT {
    ...
    private TourCategory insertedTourCategory;
    ...
    @AfterEach
    public void cleanup() {
        if (insertedTourCategory != null) {
            tourCategoryRepository.delete(insertedTourCategory);
            insertedTourCategory = null;
        }
    }
    ...
    void createTourCategory() throws Exception {
        ...
        insertedTourCategory = returnedTourCategory;
    }
    ...
    void getAllTourCategories() throws Exception {
        ...
        insertedTourCategory = tourCategoryRepository.saveAndFlush(tourCategory);
    ...
    void partialUpdateTourCategoryWithPatch() throws Exception {
        ...
        partialUpdatedTourCategory.code(UPDATED_CODE).enabled(UPDATED_ENABLED).createdDate(UPDATED_CREATED_DATE);
