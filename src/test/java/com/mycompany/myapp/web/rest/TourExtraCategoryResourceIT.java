...
import com.mycompany.myapp.repository.TourExtraCategoryRepository;
import com.mycompany.myapp.repository.UserRepository;
import com.mycompany.myapp.service.TourExtraCategoryService;
import com.mycompany.myapp.service.dto.TourExtraCategoryDTO;
import com.mycompany.myapp.service.mapper.TourExtraCategoryMapper;
...
class TourExtraCategoryResourceIT {
    ...
    private TourExtraCategory insertedTourExtraCategory;
    ...
    @AfterEach
    public void cleanup() {
        if (insertedTourExtraCategory != null) {
            tourExtraCategoryRepository.delete(insertedTourExtraCategory);
            insertedTourExtraCategory = null;
        }
    }
    ...
    void createTourExtraCategory() throws Exception {
        ...
        insertedTourExtraCategory = returnedTourExtraCategory;
    }
    ...
    void getAllTourExtraCategories() throws Exception {
        ...
        insertedTourExtraCategory = tourExtraCategoryRepository.saveAndFlush(tourExtraCategory);
