...
import com.mycompany.myapp.service.mapper.ImageFileMapper;
...
class ImageFileResourceIT {
    ...
    private ImageFile insertedImageFile;
    ...
    @AfterEach
    public void cleanup() {
        if (insertedImageFile != null) {
            imageFileRepository.delete(insertedImageFile);
            insertedImageFile = null;
        }
    }
    ...
    void createImageFile() throws Exception {
        ...
        insertedImageFile = returnedImageFile;
    }
    ...
    void getAllImageFiles() throws Exception {
        ...
        insertedImageFile = imageFileRepository.saveAndFlush(imageFile);
