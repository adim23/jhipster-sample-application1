...
import com.mycompany.myapp.repository.TourScheduleRepository;
import com.mycompany.myapp.repository.UserRepository;
import com.mycompany.myapp.service.TourScheduleService;
import com.mycompany.myapp.service.dto.TourScheduleDTO;
import com.mycompany.myapp.service.mapper.TourScheduleMapper;
...
class TourScheduleResourceIT {
    ...
    private TourSchedule insertedTourSchedule;
    ...
    @AfterEach
    public void cleanup() {
        if (insertedTourSchedule != null) {
            tourScheduleRepository.delete(insertedTourSchedule);
            insertedTourSchedule = null;
        }
    }
    ...
    void createTourSchedule() throws Exception {
        ...
        insertedTourSchedule = returnedTourSchedule;
    }
    ...
    void getAllTourSchedules() throws Exception {
        ...
        insertedTourSchedule = tourScheduleRepository.saveAndFlush(tourSchedule);
    ...
    void partialUpdateTourScheduleWithPatch() throws Exception {
        ...
        partialUpdatedTourSchedule.startDatetime(UPDATED_START_DATETIME).noKids(UPDATED_NO_KIDS).createdDate(UPDATED_CREATED_DATE);
