...
import com.mycompany.myapp.repository.TourContentRepository;
import com.mycompany.myapp.service.TourContentService;
import com.mycompany.myapp.service.dto.TourContentDTO;
import com.mycompany.myapp.service.mapper.TourContentMapper;
...
class TourContentResourceIT {
    ...
    private TourContent insertedTourContent;
    ...
    @AfterEach
    public void cleanup() {
        if (insertedTourContent != null) {
            tourContentRepository.delete(insertedTourContent);
            insertedTourContent = null;
        }
    }
    ...
    void createTourContent() throws Exception {
        ...
        insertedTourContent = returnedTourContent;
    }
    ...
    void getAllTourContents() throws Exception {
        ...
        insertedTourContent = tourContentRepository.saveAndFlush(tourContent);
