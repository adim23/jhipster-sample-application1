...
import com.mycompany.myapp.repository.WebPageRepository;
import com.mycompany.myapp.service.WebPageService;
import com.mycompany.myapp.service.dto.WebPageDTO;
import com.mycompany.myapp.service.mapper.WebPageMapper;
...
class WebPageResourceIT {
    ...
    private WebPage insertedWebPage;
    ...
    @AfterEach
    public void cleanup() {
        if (insertedWebPage != null) {
            webPageRepository.delete(insertedWebPage);
            insertedWebPage = null;
        }
    }
    ...
    void createWebPage() throws Exception {
        ...
        insertedWebPage = returnedWebPage;
    }
    ...
    void getAllWebPages() throws Exception {
        ...
        insertedWebPage = webPageRepository.saveAndFlush(webPage);
    ...
    void partialUpdateWebPageWithPatch() throws Exception {
        ...
        partialUpdatedWebPage.enabled(UPDATED_ENABLED).uriPath(UPDATED_URI_PATH).publishDate(UPDATED_PUBLISH_DATE);
