    ...
    <Row>
      <Col md="8">
        <h2 data-cy="tourExtraDetailsHeading">
          <Translate contentKey="jhipsterSampleApplication1App.tourExtra.detail.title">TourExtra</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipsterSampleApplication1App.tourExtra.tags">Tags</Translate>
          </dt>
          <dd>
          ...
          <dt>
            <Translate contentKey="jhipsterSampleApplication1App.tourExtra.category">Category</Translate>
          </dt>
          <dd>
          ...
          <dt>
            <Translate contentKey="jhipsterSampleApplication1App.tourExtra.tours">Tours</Translate>
          </dt>
          <dd>
