  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.tourExtra.home.createOrEditLabel" data-cy="TourExtraCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.tourExtra.home.createOrEditLabel">Create or edit a TourExtra</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtra.code')}
                id="tour-extra-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtra.enabled')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtra.icon')}
                id="tour-extra-icon"
                name="icon"
                data-cy="icon"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtra.price')}
                id="tour-extra-price"
                name="price"
                data-cy="price"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtra.offer')}
                id="tour-extra-offer"
                name="offer"
                data-cy="offer"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtra.shopProductId')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtra.shopUrl')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtra.createdDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtra.defaultImage')}
              ...
              />
              <ValidatedBlobField
                label={translate('jhipsterSampleApplication1App.tourExtra.defaultImageData')}
              ...
              <ValidatedField
                ...
                name="createdBy"
                data-cy="createdBy"
                label={translate('jhipsterSampleApplication1App.tourExtra.createdBy')}
                type="select"
              >
                <option value="" key="0" />
                {users
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtra.tags')}
                id="tour-extra-tags"
                data-cy="tags"
                type="select"
                multiple
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtra.category')}
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtra.tours')}
                id="tour-extra-tours"
                data-cy="tours"
                type="select"
                multiple
