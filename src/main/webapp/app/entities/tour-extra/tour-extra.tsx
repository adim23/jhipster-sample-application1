  ...
  return (
    <div>
      <h2 id="tour-extra-heading" data-cy="TourExtraHeading">
        <Translate contentKey="jhipsterSampleApplication1App.tourExtra.home.title">Tour Extras</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterSampleApplication1App.tourExtra.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/tour-extra/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSampleApplication1App.tourExtra.home.createLabel">Create new Tour Extra</Translate>
          </Link>
        </div>
      </h2>
        ...
        {tourExtraList && tourExtraList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtra.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtra.code">Code</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('code')} />
                </th>
                <th className="hand" onClick={sort('enabled')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtra.enabled">Enabled</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('enabled')} />
                </th>
                <th className="hand" onClick={sort('icon')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtra.icon">Icon</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('icon')} />
                </th>
                <th className="hand" onClick={sort('price')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtra.price">Price</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('price')} />
                </th>
                <th className="hand" onClick={sort('offer')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtra.offer">Offer</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('offer')} />
                </th>
                <th className="hand" onClick={sort('shopProductId')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtra.shopProductId">Shop Product Id</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('shopProductId')} />
                </th>
                <th className="hand" onClick={sort('shopUrl')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtra.shopUrl">Shop Url</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('shopUrl')} />
                </th>
                <th className="hand" onClick={sort('createdDate')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtra.createdDate">Created Date</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('createdDate')} />
                </th>
                <th className="hand" onClick={sort('defaultImage')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtra.defaultImage">Default Image</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('defaultImage')} />
                </th>
                <th className="hand" onClick={sort('defaultImageData')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtra.defaultImageData">Default Image Data</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('defaultImageData')} />
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtra.createdBy">Created By</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplication1App.tourExtra.home.notFound">No Tour Extras found</Translate>
            </div>
          )
        )}
      </div>
