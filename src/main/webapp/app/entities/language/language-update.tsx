  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.language.home.createOrEditLabel" data-cy="LanguageCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.language.home.createOrEditLabel">Create or edit a Language</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.language.code')}
                id="language-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.language.icon')}
                id="language-icon"
                name="icon"
                data-cy="icon"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.language.defaultImage')}
              ...
              />
              <ValidatedBlobField
                label={translate('jhipsterSampleApplication1App.language.defaultImageData')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.language.createdDate')}
              ...
              <ValidatedField
                ...
                name="createdBy"
                data-cy="createdBy"
                label={translate('jhipsterSampleApplication1App.language.createdBy')}
                type="select"
              >
                <option value="" key="0" />
                {users
