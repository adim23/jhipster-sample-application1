...
export const LanguageDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication1App.language.delete.question">
        <Translate contentKey="jhipsterSampleApplication1App.language.delete.question" interpolate={{ id: languageEntity.id }}>
