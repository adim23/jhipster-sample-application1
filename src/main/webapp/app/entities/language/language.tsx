  ...
  return (
    <div>
      <h2 id="language-heading" data-cy="LanguageHeading">
        <Translate contentKey="jhipsterSampleApplication1App.language.home.title">Languages</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterSampleApplication1App.language.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/language/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSampleApplication1App.language.home.createLabel">Create new Language</Translate>
          </Link>
        </div>
      </h2>
        ...
        {languageList && languageList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterSampleApplication1App.language.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="jhipsterSampleApplication1App.language.code">Code</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('code')} />
                </th>
                <th className="hand" onClick={sort('icon')}>
                  <Translate contentKey="jhipsterSampleApplication1App.language.icon">Icon</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('icon')} />
                </th>
                <th className="hand" onClick={sort('defaultImage')}>
                  <Translate contentKey="jhipsterSampleApplication1App.language.defaultImage">Default Image</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('defaultImage')} />
                </th>
                <th className="hand" onClick={sort('defaultImageData')}>
                  <Translate contentKey="jhipsterSampleApplication1App.language.defaultImageData">Default Image Data</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('defaultImageData')} />
                </th>
                <th className="hand" onClick={sort('createdDate')}>
                  <Translate contentKey="jhipsterSampleApplication1App.language.createdDate">Created Date</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('createdDate')} />
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplication1App.language.createdBy">Created By</Translate>{' '}
            ...
            <tbody>
              {languageList.map((language, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {language.defaultImageData ? (
                      <div>
                        {language.defaultImageDataContentType ? (
                          <a onClick={openFile(language.defaultImageDataContentType, language.defaultImageData)}>
                            <img
                              src={`data:${language.defaultImageDataContentType};base64,${language.defaultImageData}`}
                        ...
                        <span>
                          {language.defaultImageDataContentType}, {byteSize(language.defaultImageData)}
                        </span>
                      </div>
                    ) : null}
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplication1App.language.home.notFound">No Languages found</Translate>
            </div>
          )
        )}
      </div>
