...
export const VehicleDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication1App.vehicle.delete.question">
        <Translate contentKey="jhipsterSampleApplication1App.vehicle.delete.question" interpolate={{ id: vehicleEntity.id }}>
