...
export const TourContentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication1App.tourContent.delete.question">
        <Translate contentKey="jhipsterSampleApplication1App.tourContent.delete.question" interpolate={{ id: tourContentEntity.id }}>
