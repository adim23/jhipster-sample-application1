  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.tourContent.home.createOrEditLabel" data-cy="TourContentCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.tourContent.home.createOrEditLabel">
              Create or edit a TourContent
            </Translate>
          </h2>
        </Col>
      </Row>
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourContent.code')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourContent.title')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourContent.shortDescription')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourContent.data')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourContent.meta')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourContent.cancellation')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourContent.activityPath')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourContent.atAGlance')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourContent.inDetail')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourContent.whatIsIncluded')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourContent.youCanAdd')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourContent.importantInformation')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourContent.extraInfo')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourContent.createdDate')}
              ...
              <ValidatedField
                ...
                name="language"
                data-cy="language"
                label={translate('jhipsterSampleApplication1App.tourContent.language')}
                type="select"
                required
              >
                <option value="" key="0" />
