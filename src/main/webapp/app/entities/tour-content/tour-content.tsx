  ...
  return (
    <div>
      <h2 id="tour-content-heading" data-cy="TourContentHeading">
        <Translate contentKey="jhipsterSampleApplication1App.tourContent.home.title">Tour Contents</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterSampleApplication1App.tourContent.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/tour-content/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSampleApplication1App.tourContent.home.createLabel">Create new Tour Content</Translate>
          </Link>
        </div>
      </h2>
        ...
        {tourContentList && tourContentList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourContent.id">ID</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplication1App.tourContent.home.notFound">No Tour Contents found</Translate>
            </div>
          )
        )}
      </div>
