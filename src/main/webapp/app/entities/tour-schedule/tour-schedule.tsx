  ...
  return (
    <div>
      <h2 id="tour-schedule-heading" data-cy="TourScheduleHeading">
        <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.home.title">Tour Schedules</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/tour-schedule/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.home.createLabel">Create new Tour Schedule</Translate>
          </Link>
        </div>
      </h2>
        ...
        {tourScheduleList && tourScheduleList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.code">Code</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('code')} />
                </th>
                <th className="hand" onClick={sort('startDatetime')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.startDatetime">Start Datetime</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('startDatetime')} />
                </th>
                <th className="hand" onClick={sort('noPassengers')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.noPassengers">No Passengers</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('noPassengers')} />
                </th>
                <th className="hand" onClick={sort('noKids')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.noKids">No Kids</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('noKids')} />
                </th>
                <th className="hand" onClick={sort('noPets')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.noPets">No Pets</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('noPets')} />
                </th>
                <th className="hand" onClick={sort('createdDate')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.createdDate">Created Date</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('createdDate')} />
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.createdBy">Created By</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.tour">Tour</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.vehicle">Vehicle</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.driver">Driver</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.home.notFound">No Tour Schedules found</Translate>
            </div>
          )
        )}
      </div>
