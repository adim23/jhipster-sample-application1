...
export const TourScheduleDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication1App.tourSchedule.delete.question">
        <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.delete.question" interpolate={{ id: tourScheduleEntity.id }}>
