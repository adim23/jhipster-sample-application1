  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.tourSchedule.home.createOrEditLabel" data-cy="TourScheduleCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.home.createOrEditLabel">
              Create or edit a TourSchedule
            </Translate>
          </h2>
        </Col>
      </Row>
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourSchedule.code')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourSchedule.startDatetime')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourSchedule.noPassengers')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourSchedule.noKids')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourSchedule.noPets')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourSchedule.createdDate')}
              ...
              <ValidatedField
                ...
                name="createdBy"
                data-cy="createdBy"
                label={translate('jhipsterSampleApplication1App.tourSchedule.createdBy')}
                type="select"
              >
                <option value="" key="0" />
                {users
              ...
              <ValidatedField
                ...
                name="tour"
                data-cy="tour"
                label={translate('jhipsterSampleApplication1App.tourSchedule.tour')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="vehicle"
                data-cy="vehicle"
                label={translate('jhipsterSampleApplication1App.tourSchedule.vehicle')}
                type="select"
              >
                <option value="" key="0" />
                {vehicles
              ...
              <ValidatedField
                ...
                name="driver"
                data-cy="driver"
                label={translate('jhipsterSampleApplication1App.tourSchedule.driver')}
                type="select"
              >
                <option value="" key="0" />
                {drivers
