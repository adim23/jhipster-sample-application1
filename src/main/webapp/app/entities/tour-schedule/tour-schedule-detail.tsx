    ...
    <Row>
      <Col md="8">
        <h2 data-cy="tourScheduleDetailsHeading">
          <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.detail.title">TourSchedule</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipsterSampleApplication1App.tourSchedule.tour">Tour</Translate>
          </dt>
