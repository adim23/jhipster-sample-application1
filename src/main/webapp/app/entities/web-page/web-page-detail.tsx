    ...
    <Row>
      <Col md="8">
        <h2 data-cy="webPageDetailsHeading">
          <Translate contentKey="jhipsterSampleApplication1App.webPage.detail.title">WebPage</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipsterSampleApplication1App.webPage.tags">Tags</Translate>
          </dt>
          <dd>
            {webPageEntity.tags
