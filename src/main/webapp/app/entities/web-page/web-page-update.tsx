  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.webPage.home.createOrEditLabel" data-cy="WebPageCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.webPage.home.createOrEditLabel">Create or edit a WebPage</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.webPage.code')}
                id="web-page-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.webPage.enabled')}
                id="web-page-enabled"
                name="enabled"
                data-cy="enabled"
                check
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.webPage.uriPath')}
                id="web-page-uriPath"
                name="uriPath"
                data-cy="uriPath"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.webPage.publishDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.webPage.createdDate')}
              ...
              <ValidatedField
                ...
                name="createdBy"
                data-cy="createdBy"
                label={translate('jhipsterSampleApplication1App.webPage.createdBy')}
                type="select"
              >
                <option value="" key="0" />
                {users
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.webPage.tags')}
                id="web-page-tags"
                data-cy="tags"
                type="select"
                multiple
