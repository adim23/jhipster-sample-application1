...
export const PromotionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication1App.promotion.delete.question">
        <Translate contentKey="jhipsterSampleApplication1App.promotion.delete.question" interpolate={{ id: promotionEntity.id }}>
