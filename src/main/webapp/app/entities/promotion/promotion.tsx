  ...
  return (
    <div>
      <h2 id="promotion-heading" data-cy="PromotionHeading">
        <Translate contentKey="jhipsterSampleApplication1App.promotion.home.title">Promotions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterSampleApplication1App.promotion.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/promotion/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSampleApplication1App.promotion.home.createLabel">Create new Promotion</Translate>
          </Link>
        </div>
      </h2>
        ...
        {promotionList && promotionList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterSampleApplication1App.promotion.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="jhipsterSampleApplication1App.promotion.code">Code</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('code')} />
                </th>
                <th className="hand" onClick={sort('enabled')}>
                  <Translate contentKey="jhipsterSampleApplication1App.promotion.enabled">Enabled</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('enabled')} />
                </th>
                <th className="hand" onClick={sort('discount')}>
                  <Translate contentKey="jhipsterSampleApplication1App.promotion.discount">Discount</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('discount')} />
                </th>
                <th className="hand" onClick={sort('fromDate')}>
                  <Translate contentKey="jhipsterSampleApplication1App.promotion.fromDate">From Date</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('fromDate')} />
                </th>
                <th className="hand" onClick={sort('toDate')}>
                  <Translate contentKey="jhipsterSampleApplication1App.promotion.toDate">To Date</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplication1App.promotion.home.notFound">No Promotions found</Translate>
            </div>
          )
        )}
      </div>
