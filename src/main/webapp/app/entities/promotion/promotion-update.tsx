  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.promotion.home.createOrEditLabel" data-cy="PromotionCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.promotion.home.createOrEditLabel">Create or edit a Promotion</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.promotion.code')}
                id="promotion-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.promotion.enabled')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.promotion.discount')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.promotion.fromDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.promotion.toDate')}
                id="promotion-toDate"
                name="toDate"
                data-cy="toDate"
                type="date"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.promotion.tour')}
                id="promotion-tour"
                data-cy="tour"
                type="select"
                multiple
