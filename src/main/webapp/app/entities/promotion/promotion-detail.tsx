    ...
    <Row>
      <Col md="8">
        <h2 data-cy="promotionDetailsHeading">
          <Translate contentKey="jhipsterSampleApplication1App.promotion.detail.title">Promotion</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipsterSampleApplication1App.promotion.tour">Tour</Translate>
          </dt>
          <dd>
