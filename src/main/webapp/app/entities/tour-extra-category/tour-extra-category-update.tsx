  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.tourExtraCategory.home.createOrEditLabel" data-cy="TourExtraCategoryCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.tourExtraCategory.home.createOrEditLabel">
              Create or edit a TourExtraCategory
            </Translate>
          </h2>
        </Col>
      </Row>
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtraCategory.code')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtraCategory.enabled')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtraCategory.icon')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtraCategory.defaultImage')}
              ...
              />
              <ValidatedBlobField
                label={translate('jhipsterSampleApplication1App.tourExtraCategory.defaultImageData')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtraCategory.shopCategoryId')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtraCategory.shopUrl')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtraCategory.createdDate')}
              ...
              <ValidatedField
                ...
                name="createdBy"
                data-cy="createdBy"
                label={translate('jhipsterSampleApplication1App.tourExtraCategory.createdBy')}
                type="select"
              >
                <option value="" key="0" />
                {users
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourExtraCategory.extra')}
