  ...
  return (
    <div>
      <h2 id="tour-extra-category-heading" data-cy="TourExtraCategoryHeading">
        <Translate contentKey="jhipsterSampleApplication1App.tourExtraCategory.home.title">Tour Extra Categories</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterSampleApplication1App.tourExtraCategory.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="jhipsterSampleApplication1App.tourExtraCategory.home.createLabel">
              Create new Tour Extra Category
            </Translate>
          </Link>
        </div>
      </h2>
        ...
        {tourExtraCategoryList && tourExtraCategoryList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtraCategory.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtraCategory.code">Code</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('code')} />
                </th>
                <th className="hand" onClick={sort('enabled')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtraCategory.enabled">Enabled</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('enabled')} />
                </th>
                <th className="hand" onClick={sort('icon')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtraCategory.icon">Icon</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('icon')} />
                </th>
                <th className="hand" onClick={sort('defaultImage')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtraCategory.defaultImage">Default Image</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('defaultImage')} />
                </th>
                <th className="hand" onClick={sort('defaultImageData')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtraCategory.defaultImageData">Default Image Data</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('defaultImageData')} />
                </th>
                <th className="hand" onClick={sort('shopCategoryId')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtraCategory.shopCategoryId">Shop Category Id</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('shopCategoryId')} />
                </th>
                <th className="hand" onClick={sort('shopUrl')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtraCategory.shopUrl">Shop Url</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('shopUrl')} />
                </th>
                <th className="hand" onClick={sort('createdDate')}>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtraCategory.createdDate">Created Date</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('createdDate')} />
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplication1App.tourExtraCategory.createdBy">Created By</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplication1App.tourExtraCategory.home.notFound">
                No Tour Extra Categories found
              </Translate>
            </div>
          )
        )}
