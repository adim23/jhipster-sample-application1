    ...
    <Row>
      <Col md="8">
        <h2 data-cy="tourExtraCategoryDetailsHeading">
          <Translate contentKey="jhipsterSampleApplication1App.tourExtraCategory.detail.title">TourExtraCategory</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipsterSampleApplication1App.tourExtraCategory.extra">Extra</Translate>
          </dt>
          <dd>
