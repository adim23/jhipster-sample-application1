...
export const PlaceCategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication1App.placeCategory.delete.question">
        <Translate contentKey="jhipsterSampleApplication1App.placeCategory.delete.question" interpolate={{ id: placeCategoryEntity.id }}>
