  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.placeCategory.home.createOrEditLabel" data-cy="PlaceCategoryCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.placeCategory.home.createOrEditLabel">
              Create or edit a PlaceCategory
            </Translate>
          </h2>
        </Col>
      </Row>
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.placeCategory.code')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.placeCategory.enabled')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.placeCategory.icon')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.placeCategory.createdDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.placeCategory.defaultImage')}
              ...
              />
              <ValidatedBlobField
                label={translate('jhipsterSampleApplication1App.placeCategory.defaultImageData')}
              ...
              <ValidatedField
                ...
                name="createdBy"
                data-cy="createdBy"
                label={translate('jhipsterSampleApplication1App.placeCategory.createdBy')}
                type="select"
              >
                <option value="" key="0" />
                {users
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.placeCategory.place')}
