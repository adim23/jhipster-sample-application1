    ...
    <Row>
      <Col md="8">
        <h2 data-cy="placeCategoryDetailsHeading">
          <Translate contentKey="jhipsterSampleApplication1App.placeCategory.detail.title">PlaceCategory</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipsterSampleApplication1App.placeCategory.place">Place</Translate>
          </dt>
          <dd>
