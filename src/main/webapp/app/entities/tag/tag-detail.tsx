    ...
    <Row>
      <Col md="8">
        <h2 data-cy="tagDetailsHeading">
          <Translate contentKey="jhipsterSampleApplication1App.tag.detail.title">Tag</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipsterSampleApplication1App.tag.place">Place</Translate>
          </dt>
          <dd>
            {tagEntity.places
          ...
          <dt>
            <Translate contentKey="jhipsterSampleApplication1App.tag.tour">Tour</Translate>
          </dt>
          <dd>
            {tagEntity.tours
          ...
          <dt>
            <Translate contentKey="jhipsterSampleApplication1App.tag.tourExtra">Tour Extra</Translate>
          </dt>
          <dd>
          ...
          <dt>
            <Translate contentKey="jhipsterSampleApplication1App.tag.webPage">Web Page</Translate>
          </dt>
          <dd>
            {tagEntity.webPages
