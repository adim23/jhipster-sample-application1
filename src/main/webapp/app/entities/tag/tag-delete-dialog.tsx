...
export const TagDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication1App.tag.delete.question">
        <Translate contentKey="jhipsterSampleApplication1App.tag.delete.question" interpolate={{ id: tagEntity.id }}>
