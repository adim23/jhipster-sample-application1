  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.tag.home.createOrEditLabel" data-cy="TagCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.tag.home.createOrEditLabel">Create or edit a Tag</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tag.code')}
                id="tag-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tag.place')}
                id="tag-place"
                data-cy="place"
                type="select"
                multiple
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tag.tour')}
                id="tag-tour"
                data-cy="tour"
                type="select"
                multiple
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tag.tourExtra')}
                id="tag-tourExtra"
                data-cy="tourExtra"
                type="select"
                multiple
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tag.webPage')}
                id="tag-webPage"
                data-cy="webPage"
                type="select"
                multiple
