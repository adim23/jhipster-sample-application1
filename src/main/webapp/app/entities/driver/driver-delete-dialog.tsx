...
export const DriverDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication1App.driver.delete.question">
        <Translate contentKey="jhipsterSampleApplication1App.driver.delete.question" interpolate={{ id: driverEntity.id }}>
