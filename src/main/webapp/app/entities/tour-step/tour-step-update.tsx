  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.tourStep.home.createOrEditLabel" data-cy="TourStepCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.tourStep.home.createOrEditLabel">Create or edit a TourStep</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourStep.code')}
                id="tour-step-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourStep.enabled')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourStep.icon')}
                id="tour-step-icon"
                name="icon"
                data-cy="icon"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourStep.stepOrder')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourStep.waitTime')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourStep.waitTimeMeasure')}
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourStep.driveTime')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourStep.driveTimeMeasure')}
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourStep.createdDate')}
              ...
              <ValidatedField
                ...
                name="createdBy"
                data-cy="createdBy"
                label={translate('jhipsterSampleApplication1App.tourStep.createdBy')}
                type="select"
              >
                <option value="" key="0" />
                {users
              ...
              <ValidatedField
                ...
                name="tour"
                data-cy="tour"
                label={translate('jhipsterSampleApplication1App.tourStep.tour')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="place"
                data-cy="place"
                label={translate('jhipsterSampleApplication1App.tourStep.place')}
                type="select"
                required
              >
                <option value="" key="0" />
