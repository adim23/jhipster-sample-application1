...
export const ImageFileDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication1App.imageFile.delete.question">
        <Translate contentKey="jhipsterSampleApplication1App.imageFile.delete.question" interpolate={{ id: imageFileEntity.id }}>
