  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.imageFile.home.createOrEditLabel" data-cy="ImageFileCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.imageFile.home.createOrEditLabel">Create or edit a ImageFile</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.imageFile.code')}
                id="image-file-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.imageFile.title')}
                id="image-file-title"
                name="title"
                data-cy="title"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.imageFile.alt')}
                id="image-file-alt"
                name="alt"
                data-cy="alt"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.imageFile.filename')}
              ...
              />
              <ValidatedBlobField
                label={translate('jhipsterSampleApplication1App.imageFile.data')}
                id="image-file-data"
                name="data"
                data-cy="data"
                isImage
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.imageFile.createdDate')}
              ...
              <ValidatedField
                ...
                name="createdBy"
                data-cy="createdBy"
                label={translate('jhipsterSampleApplication1App.imageFile.createdBy')}
                type="select"
              >
                <option value="" key="0" />
                {users
              ...
              <ValidatedField
                ...
                name="destination"
                data-cy="destination"
                label={translate('jhipsterSampleApplication1App.imageFile.destination')}
                type="select"
              >
                <option value="" key="0" />
                {destinations
              ...
              <ValidatedField
                ...
                name="tour"
                data-cy="tour"
                label={translate('jhipsterSampleApplication1App.imageFile.tour')}
                type="select"
              >
                <option value="" key="0" />
                {tours
              ...
              <ValidatedField
                ...
                label={translate('jhipsterSampleApplication1App.imageFile.tourCategory')}
                type="select"
              >
                <option value="" key="0" />
                {tourCategories
              ...
              <ValidatedField
                ...
                name="place"
                data-cy="place"
                label={translate('jhipsterSampleApplication1App.imageFile.place')}
                type="select"
              >
                <option value="" key="0" />
                {places
              ...
              <ValidatedField
                ...
                label={translate('jhipsterSampleApplication1App.imageFile.placeCategory')}
                type="select"
              >
                <option value="" key="0" />
                {placeCategories
              ...
              <ValidatedField
                ...
                label={translate('jhipsterSampleApplication1App.imageFile.tourExtraCategory')}
                type="select"
              >
                <option value="" key="0" />
                {tourExtraCategories
              ...
              <ValidatedField
                ...
                name="tourExtra"
                data-cy="tourExtra"
                label={translate('jhipsterSampleApplication1App.imageFile.tourExtra')}
                type="select"
              >
                <option value="" key="0" />
                {tourExtras
              ...
              <ValidatedField
                ...
                name="vehicle"
                data-cy="vehicle"
                label={translate('jhipsterSampleApplication1App.imageFile.vehicle')}
                type="select"
              >
                <option value="" key="0" />
                {vehicles
              ...
              <ValidatedField
                ...
                name="driver"
                data-cy="driver"
                label={translate('jhipsterSampleApplication1App.imageFile.driver')}
                type="select"
              >
                <option value="" key="0" />
                {drivers
