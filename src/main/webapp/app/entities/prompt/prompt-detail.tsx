    ...
    <Row>
      <Col md="8">
        <h2 data-cy="promptDetailsHeading">
          <Translate contentKey="jhipsterSampleApplication1App.prompt.detail.title">Prompt</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipsterSampleApplication1App.prompt.language">Language</Translate>
          </dt>
