  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.prompt.home.createOrEditLabel" data-cy="PromptCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.prompt.home.createOrEditLabel">Create or edit a Prompt</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.prompt.key')}
                id="prompt-key"
                name="key"
                data-cy="key"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.prompt.value')}
                id="prompt-value"
                name="value"
                data-cy="value"
                type="text"
              ...
              <ValidatedField
                ...
                name="language"
                data-cy="language"
                label={translate('jhipsterSampleApplication1App.prompt.language')}
                type="select"
                required
              >
                <option value="" key="0" />
