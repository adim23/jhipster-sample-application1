  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.tour.home.createOrEditLabel" data-cy="TourCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.tour.home.createOrEditLabel">Create or edit a Tour</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.code')}
                id="tour-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.enabled')}
                id="tour-enabled"
                name="enabled"
                data-cy="enabled"
                check
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.kind')}
                id="tour-kind"
                name="kind"
                data-cy="kind"
                type="select"
              >
                {tourKindValues.map(tourKind => (
                  <option value={tourKind} key={tourKind}>
                    {translate('jhipsterSampleApplication1App.TourKind.' + tourKind)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.mode')}
                id="tour-mode"
                name="mode"
                data-cy="mode"
                type="select"
              >
                {tourModeValues.map(tourMode => (
                  <option value={tourMode} key={tourMode}>
                    {translate('jhipsterSampleApplication1App.TourMode.' + tourMode)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.icon')}
                id="tour-icon"
                name="icon"
                data-cy="icon"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.duration')}
                id="tour-duration"
                name="duration"
                data-cy="duration"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.durationMeasure')}
              ...
              >
                {durationMeasureValues.map(durationMeasure => (
                  <option value={durationMeasure} key={durationMeasure}>
                    {translate('jhipsterSampleApplication1App.DurationMeasure.' + durationMeasure)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.petFriendly')}
                id="tour-petFriendly"
                name="petFriendly"
                data-cy="petFriendly"
                check
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.kidsAllowed')}
                id="tour-kidsAllowed"
                name="kidsAllowed"
                data-cy="kidsAllowed"
                check
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.smoking')}
                id="tour-smoking"
                name="smoking"
                data-cy="smoking"
                check
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.availableFromDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.availableToDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.initialPrice')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.price')}
                id="tour-price"
                name="price"
                data-cy="price"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.badge')}
                id="tour-badge"
                name="badge"
                data-cy="badge"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.rating')}
                id="tour-rating"
                name="rating"
                data-cy="rating"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.widgetId')}
                id="tour-widgetId"
                name="widgetId"
                data-cy="widgetId"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.externalId')}
                id="tour-externalId"
                name="externalId"
                data-cy="externalId"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.createdDate')}
                id="tour-createdDate"
                name="createdDate"
                data-cy="createdDate"
                type="date"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.defaultImage')}
              ...
              />
              <ValidatedBlobField
                label={translate('jhipsterSampleApplication1App.tour.defaultImageData')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.accessibility')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.audioGuide')}
                id="tour-audioGuide"
                name="audioGuide"
                data-cy="audioGuide"
                check
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.tourGuide')}
                id="tour-tourGuide"
                name="tourGuide"
                data-cy="tourGuide"
                check
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.cssStyle')}
                id="tour-cssStyle"
                name="cssStyle"
                data-cy="cssStyle"
                type="textarea"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.departure')}
                id="tour-departure"
                name="departure"
                data-cy="departure"
                type="date"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.returnTime')}
                id="tour-returnTime"
                name="returnTime"
                data-cy="returnTime"
                type="date"
              ...
              <ValidatedField
                ...
                name="content"
                data-cy="content"
                label={translate('jhipsterSampleApplication1App.tour.content')}
                type="select"
              >
                <option value="" key="0" />
                {tourContents
              ...
              <ValidatedField
                ...
                name="createdBy"
                data-cy="createdBy"
                label={translate('jhipsterSampleApplication1App.tour.createdBy')}
                type="select"
              >
                <option value="" key="0" />
                {users
              ...
              <ValidatedField
                ...
                label={translate('jhipsterSampleApplication1App.tour.meetingPoint')}
                type="select"
              >
                <option value="" key="0" />
                {places
              ...
              <ValidatedField
                ...
                name="finishPoint"
                data-cy="finishPoint"
                label={translate('jhipsterSampleApplication1App.tour.finishPoint')}
                type="select"
              >
                <option value="" key="0" />
                {places
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.tourExtra')}
                id="tour-tourExtra"
                data-cy="tourExtra"
                type="select"
                multiple
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.tags')}
                id="tour-tags"
                data-cy="tags"
                type="select"
                multiple
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.promotions')}
                id="tour-promotions"
                data-cy="promotions"
                type="select"
                multiple
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tour.category')}
                id="tour-category"
                data-cy="category"
                type="select"
                multiple
              ...
              <ValidatedField
                ...
                name="destination"
                data-cy="destination"
                label={translate('jhipsterSampleApplication1App.tour.destination')}
                type="select"
              >
                <option value="" key="0" />
                {destinations
              ...
              <ValidatedField
                ...
                label={translate('jhipsterSampleApplication1App.tour.defaultCategory')}
                type="select"
              >
                <option value="" key="0" />
                {tourCategories
