...
export const TourDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication1App.tour.delete.question">
        <Translate contentKey="jhipsterSampleApplication1App.tour.delete.question" interpolate={{ id: tourEntity.id }}>
