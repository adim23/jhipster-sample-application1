  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.destination.home.createOrEditLabel" data-cy="DestinationCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.destination.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.destination.code')}
                id="destination-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.destination.enabled')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.destination.defaultImage')}
              ...
              />
              <ValidatedBlobField
                label={translate('jhipsterSampleApplication1App.destination.defaultImageData')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.destination.cssStyle')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.destination.createdDate')}
              ...
              <ValidatedField
                ...
                name="createdBy"
                data-cy="createdBy"
                label={translate('jhipsterSampleApplication1App.destination.createdBy')}
                type="select"
              >
                <option value="" key="0" />
                {users
