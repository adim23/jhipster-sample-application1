...
export const DestinationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication1App.destination.delete.question">
        <Translate contentKey="jhipsterSampleApplication1App.destination.delete.question" interpolate={{ id: destinationEntity.id }}>
