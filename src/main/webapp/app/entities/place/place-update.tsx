  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.place.home.createOrEditLabel" data-cy="PlaceCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.place.home.createOrEditLabel">Create or edit a Place</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.place.code')}
                id="place-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.place.enabled')}
                id="place-enabled"
                name="enabled"
                data-cy="enabled"
                check
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.place.icon')}
                id="place-icon"
                name="icon"
                data-cy="icon"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.place.destinationSight')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.place.longitude')}
                id="place-longitude"
                name="longitude"
                data-cy="longitude"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.place.latitude')}
                id="place-latitude"
                name="latitude"
                data-cy="latitude"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.place.createdDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.place.defaultImage')}
              ...
              />
              <ValidatedBlobField
                label={translate('jhipsterSampleApplication1App.place.defaultImageData')}
              ...
              <ValidatedField
                ...
                name="createdBy"
                data-cy="createdBy"
                label={translate('jhipsterSampleApplication1App.place.createdBy')}
                type="select"
              >
                <option value="" key="0" />
                {users
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.place.tags')}
                id="place-tags"
                data-cy="tags"
                type="select"
                multiple
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.place.category')}
                id="place-category"
                data-cy="category"
                type="select"
                multiple
              ...
              <ValidatedField
                ...
                name="destination"
                data-cy="destination"
                label={translate('jhipsterSampleApplication1App.place.destination')}
                type="select"
              >
                <option value="" key="0" />
                {destinations
