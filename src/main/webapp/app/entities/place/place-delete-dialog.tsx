...
export const PlaceDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication1App.place.delete.question">
        <Translate contentKey="jhipsterSampleApplication1App.place.delete.question" interpolate={{ id: placeEntity.id }}>
