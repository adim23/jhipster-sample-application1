  ...
  return (
    <div>
      <h2 id="content-heading" data-cy="ContentHeading">
        <Translate contentKey="jhipsterSampleApplication1App.content.home.title">Contents</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterSampleApplication1App.content.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/content/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSampleApplication1App.content.home.createLabel">Create new Content</Translate>
          </Link>
        </div>
      </h2>
        ...
        {contentList && contentList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterSampleApplication1App.content.id">ID</Translate>{' '}
                ...
                <th>
                  <Translate contentKey="jhipsterSampleApplication1App.content.place">Place</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                ...
                <th>
                  <Translate contentKey="jhipsterSampleApplication1App.content.menu">Menu</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplication1App.content.webPage">Web Page</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplication1App.content.tag">Tag</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplication1App.content.home.notFound">No Contents found</Translate>
            </div>
          )
        )}
      </div>
