  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.content.home.createOrEditLabel" data-cy="ContentCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.content.home.createOrEditLabel">Create or edit a Content</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.content.code')}
                id="content-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.content.title')}
                id="content-title"
                name="title"
                data-cy="title"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.content.shortDescription')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.content.data')}
                id="content-data"
                name="data"
                data-cy="data"
                type="textarea"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.content.meta')}
                id="content-meta"
                name="meta"
                data-cy="meta"
                type="textarea"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.content.createdDate')}
              ...
              <ValidatedField
                ...
                name="language"
                data-cy="language"
                label={translate('jhipsterSampleApplication1App.content.language')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="createdBy"
                data-cy="createdBy"
                label={translate('jhipsterSampleApplication1App.content.createdBy')}
                type="select"
              >
                <option value="" key="0" />
                {users
              ...
              <ValidatedField
                ...
                name="destination"
                data-cy="destination"
                label={translate('jhipsterSampleApplication1App.content.destination')}
                type="select"
              >
                <option value="" key="0" />
                {destinations
              ...
              <ValidatedField
                ...
                label={translate('jhipsterSampleApplication1App.content.tourCategory')}
                type="select"
              >
                <option value="" key="0" />
                {tourCategories
              ...
              <ValidatedField
                ...
                name="place"
                data-cy="place"
                label={translate('jhipsterSampleApplication1App.content.place')}
                type="select"
              >
                <option value="" key="0" />
                {places
              ...
              <ValidatedField
                ...
                label={translate('jhipsterSampleApplication1App.content.placeCategory')}
                type="select"
              >
                <option value="" key="0" />
                {placeCategories
              ...
              <ValidatedField
                ...
                label={translate('jhipsterSampleApplication1App.content.tourExtraCategory')}
                type="select"
              >
                <option value="" key="0" />
                {tourExtraCategories
              ...
              <ValidatedField
                ...
                name="tourExtra"
                data-cy="tourExtra"
                label={translate('jhipsterSampleApplication1App.content.tourExtra')}
                type="select"
              >
                <option value="" key="0" />
                {tourExtras
              ...
              <ValidatedField
                ...
                name="menu"
                data-cy="menu"
                label={translate('jhipsterSampleApplication1App.content.menu')}
                type="select"
              >
                <option value="" key="0" />
                {menus
              ...
              <ValidatedField
                ...
                name="webPage"
                data-cy="webPage"
                label={translate('jhipsterSampleApplication1App.content.webPage')}
                type="select"
              >
                <option value="" key="0" />
                {webPages
              ...
              <ValidatedField
                ...
                name="tag"
                data-cy="tag"
                label={translate('jhipsterSampleApplication1App.content.tag')}
                type="select"
              >
                <option value="" key="0" />
                {tags
              ...
              <ValidatedField
                ...
                name="tourStep"
                data-cy="tourStep"
                label={translate('jhipsterSampleApplication1App.content.tourStep')}
                type="select"
              >
                <option value="" key="0" />
                {tourSteps
              ...
              <ValidatedField
                ...
                name="promotion"
                data-cy="promotion"
                label={translate('jhipsterSampleApplication1App.content.promotion')}
                type="select"
              >
                <option value="" key="0" />
                {promotions
              ...
              <ValidatedField
                ...
                name="imageFile"
                data-cy="imageFile"
                label={translate('jhipsterSampleApplication1App.content.imageFile')}
                type="select"
              >
                <option value="" key="0" />
                {imageFiles
