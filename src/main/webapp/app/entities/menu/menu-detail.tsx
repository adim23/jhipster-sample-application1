    ...
    <Row>
      <Col md="8">
        <h2 data-cy="menuDetailsHeading">
          <Translate contentKey="jhipsterSampleApplication1App.menu.detail.title">Menu</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipsterSampleApplication1App.menu.page">Page</Translate>
          </dt>
          <dd>{menuEntity.page ? menuEntity.page.code : ''}</dd>
          <dt>
            <Translate contentKey="jhipsterSampleApplication1App.menu.parent">Parent</Translate>
          </dt>
