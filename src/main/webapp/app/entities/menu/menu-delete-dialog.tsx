...
export const MenuDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/menu' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication1App.menu.delete.question">
        <Translate contentKey="jhipsterSampleApplication1App.menu.delete.question" interpolate={{ id: menuEntity.id }}>
