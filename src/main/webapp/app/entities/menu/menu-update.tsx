  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.menu.home.createOrEditLabel" data-cy="MenuCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.menu.home.createOrEditLabel">Create or edit a Menu</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.menu.code')}
                id="menu-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.menu.enabled')}
                id="menu-enabled"
                name="enabled"
                data-cy="enabled"
                check
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.menu.icon')}
                id="menu-icon"
                name="icon"
                data-cy="icon"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.menu.uri')}
                id="menu-uri"
                name="uri"
                data-cy="uri"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.menu.defaultImage')}
              ...
              />
              <ValidatedBlobField
                label={translate('jhipsterSampleApplication1App.menu.defaultImageData')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.menu.createdDate')}
                id="menu-createdDate"
                name="createdDate"
                data-cy="createdDate"
                type="date"
              ...
              <ValidatedField
                ...
                name="createdBy"
                data-cy="createdBy"
                label={translate('jhipsterSampleApplication1App.menu.createdBy')}
                type="select"
              >
                <option value="" key="0" />
                {users
              ...
              <ValidatedField
                ...
                name="page"
                data-cy="page"
                label={translate('jhipsterSampleApplication1App.menu.page')}
                type="select"
              >
                <option value="" key="0" />
                {webPages
              ...
              <ValidatedField
                ...
                name="parent"
                data-cy="parent"
                label={translate('jhipsterSampleApplication1App.menu.parent')}
                type="select"
              >
                <option value="" key="0" />
                {menus
              ...
              <ValidatedField
                ...
                label={translate('jhipsterSampleApplication1App.menu.tourCategory')}
                type="select"
              >
                <option value="" key="0" />
                {tourCategories
              ...
              <ValidatedField
                ...
                name="destination"
                data-cy="destination"
                label={translate('jhipsterSampleApplication1App.menu.destination')}
                type="select"
              >
                <option value="" key="0" />
                {destinations
