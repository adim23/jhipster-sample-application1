  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.booking.home.createOrEditLabel" data-cy="BookingCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.booking.home.createOrEditLabel">Create or edit a Booking</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.booking.bookDatetime')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.booking.noPersons')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.booking.noKids')}
                id="booking-noKids"
                name="noKids"
                data-cy="noKids"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.booking.noPets')}
                id="booking-noPets"
                name="noPets"
                data-cy="noPets"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.booking.total')}
                id="booking-total"
                name="total"
                data-cy="total"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.booking.paymentType')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.booking.valid')}
                id="booking-valid"
                name="valid"
                data-cy="valid"
                check
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.booking.cancelledAt')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.booking.remoteData')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.booking.remoteId')}
                id="booking-remoteId"
                name="remoteId"
                data-cy="remoteId"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.booking.createdDate')}
              ...
              <ValidatedField
                ...
                name="schedule"
                data-cy="schedule"
                label={translate('jhipsterSampleApplication1App.booking.schedule')}
                type="select"
              >
                <option value="" key="0" />
                {tourSchedules
              ...
              <ValidatedField
                ...
                name="passenger"
                data-cy="passenger"
                label={translate('jhipsterSampleApplication1App.booking.passenger')}
                type="select"
              >
                <option value="" key="0" />
                {passengers
