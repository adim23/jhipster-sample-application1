...
export const BookingDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication1App.booking.delete.question">
        <Translate contentKey="jhipsterSampleApplication1App.booking.delete.question" interpolate={{ id: bookingEntity.id }}>
