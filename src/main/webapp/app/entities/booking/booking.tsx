  ...
  return (
    <div>
      <h2 id="booking-heading" data-cy="BookingHeading">
        <Translate contentKey="jhipsterSampleApplication1App.booking.home.title">Bookings</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterSampleApplication1App.booking.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/booking/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSampleApplication1App.booking.home.createLabel">Create new Booking</Translate>
          </Link>
        </div>
      </h2>
        ...
        {bookingList && bookingList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterSampleApplication1App.booking.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('bookDatetime')}>
                  <Translate contentKey="jhipsterSampleApplication1App.booking.bookDatetime">Book Datetime</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('bookDatetime')} />
                </th>
                <th className="hand" onClick={sort('noPersons')}>
                  <Translate contentKey="jhipsterSampleApplication1App.booking.noPersons">No Persons</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('noPersons')} />
                </th>
                <th className="hand" onClick={sort('noKids')}>
                  <Translate contentKey="jhipsterSampleApplication1App.booking.noKids">No Kids</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('noKids')} />
                </th>
                <th className="hand" onClick={sort('noPets')}>
                  <Translate contentKey="jhipsterSampleApplication1App.booking.noPets">No Pets</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('noPets')} />
                </th>
                <th className="hand" onClick={sort('total')}>
                  <Translate contentKey="jhipsterSampleApplication1App.booking.total">Total</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('total')} />
                </th>
                <th className="hand" onClick={sort('paymentType')}>
                  <Translate contentKey="jhipsterSampleApplication1App.booking.paymentType">Payment Type</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('paymentType')} />
                </th>
                <th className="hand" onClick={sort('valid')}>
                  <Translate contentKey="jhipsterSampleApplication1App.booking.valid">Valid</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('valid')} />
                </th>
                <th className="hand" onClick={sort('cancelledAt')}>
                  <Translate contentKey="jhipsterSampleApplication1App.booking.cancelledAt">Cancelled At</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('cancelledAt')} />
                </th>
                <th className="hand" onClick={sort('remoteData')}>
                  <Translate contentKey="jhipsterSampleApplication1App.booking.remoteData">Remote Data</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('remoteData')} />
                </th>
                <th className="hand" onClick={sort('remoteId')}>
                  <Translate contentKey="jhipsterSampleApplication1App.booking.remoteId">Remote Id</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('remoteId')} />
                </th>
                <th className="hand" onClick={sort('createdDate')}>
                  <Translate contentKey="jhipsterSampleApplication1App.booking.createdDate">Created Date</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('createdDate')} />
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplication1App.booking.schedule">Schedule</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplication1App.booking.passenger">Passenger</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplication1App.booking.home.notFound">No Bookings found</Translate>
            </div>
          )
        )}
      </div>
