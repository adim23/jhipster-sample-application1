...
const EntitiesMenu = () => {
  return (
    <>
      ...
      <MenuItem icon="asterisk" to="/tour-content">
        <Translate contentKey="global.menu.entities.tourContent" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/prompt">
        <Translate contentKey="global.menu.entities.prompt" />
      </MenuItem>
