  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication1App.tourCategory.home.createOrEditLabel" data-cy="TourCategoryCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplication1App.tourCategory.home.createOrEditLabel">
              Create or edit a TourCategory
            </Translate>
          </h2>
        </Col>
      </Row>
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourCategory.code')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourCategory.enabled')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourCategory.icon')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourCategory.createdDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourCategory.defaultImage')}
              ...
              />
              <ValidatedBlobField
                label={translate('jhipsterSampleApplication1App.tourCategory.defaultImageData')}
              ...
              <ValidatedField
                ...
                name="createdBy"
                data-cy="createdBy"
                label={translate('jhipsterSampleApplication1App.tourCategory.createdBy')}
                type="select"
              >
                <option value="" key="0" />
                {users
              ...
              <ValidatedField
                ...
                name="parent"
                data-cy="parent"
                label={translate('jhipsterSampleApplication1App.tourCategory.parent')}
                type="select"
              >
                <option value="" key="0" />
                {tourCategories
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplication1App.tourCategory.tour')}
