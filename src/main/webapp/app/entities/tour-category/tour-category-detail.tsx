    ...
    <Row>
      <Col md="8">
        <h2 data-cy="tourCategoryDetailsHeading">
          <Translate contentKey="jhipsterSampleApplication1App.tourCategory.detail.title">TourCategory</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipsterSampleApplication1App.tourCategory.tour">Tour</Translate>
          </dt>
          <dd>
