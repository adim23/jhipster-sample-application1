  ...
  return (
    <div>
      <h2 id="passenger-heading" data-cy="PassengerHeading">
        <Translate contentKey="jhipsterSampleApplication1App.passenger.home.title">Passengers</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterSampleApplication1App.passenger.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/passenger/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSampleApplication1App.passenger.home.createLabel">Create new Passenger</Translate>
          </Link>
        </div>
      </h2>
        ...
        {passengerList && passengerList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterSampleApplication1App.passenger.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="jhipsterSampleApplication1App.passenger.name">Name</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('name')} />
                </th>
                <th className="hand" onClick={sort('email')}>
                  <Translate contentKey="jhipsterSampleApplication1App.passenger.email">Email</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('email')} />
                </th>
                <th className="hand" onClick={sort('mobile')}>
                  <Translate contentKey="jhipsterSampleApplication1App.passenger.mobile">Mobile</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('mobile')} />
                </th>
                <th className="hand" onClick={sort('age')}>
                  <Translate contentKey="jhipsterSampleApplication1App.passenger.age">Age</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('age')} />
                </th>
                <th className="hand" onClick={sort('gender')}>
                  <Translate contentKey="jhipsterSampleApplication1App.passenger.gender">Gender</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('gender')} />
                </th>
                <th className="hand" onClick={sort('nationality')}>
                  <Translate contentKey="jhipsterSampleApplication1App.passenger.nationality">Nationality</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('nationality')} />
                </th>
                <th className="hand" onClick={sort('createdDate')}>
                  <Translate contentKey="jhipsterSampleApplication1App.passenger.createdDate">Created Date</Translate>{' '}
            ...
            <tbody>
              {passengerList.map((passenger, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {passenger.createdDate ? <TextFormat type="date" value={passenger.createdDate} format={APP_DATE_FORMAT} /> : null}
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplication1App.passenger.home.notFound">No Passengers found</Translate>
            </div>
          )
        )}
      </div>
