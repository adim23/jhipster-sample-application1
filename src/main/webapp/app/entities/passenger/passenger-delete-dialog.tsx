...
export const PassengerDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication1App.passenger.delete.question">
        <Translate contentKey="jhipsterSampleApplication1App.passenger.delete.question" interpolate={{ id: passengerEntity.id }}>
